...
//Abstract used only with 1.method and 2. class
//abstract method has only method signature not the body;//no body
//if minimum one method in the class is abstract the class must be also abstract//normal(concrete) methods also allowed
...
//a class  or method can be either abstract or final--> not both
