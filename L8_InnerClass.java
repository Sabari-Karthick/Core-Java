/**
 * @author karthick
 * Without existing one type of object if there is no chance of existing another type of object then we should go for inner classes.Example:University and Department->Tight coupling(Composition)
 ...
 * Inside Inner class static boundry never come (no static is allowed)
 * They are: 
