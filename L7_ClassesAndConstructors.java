...
public class L7_ClassesAndConstructors {// class demo(constructors)
...
class shop {
	double porkPPK;
	double chickekenPPK;
	double lambPPK; // this keyword to specify the current instance
	double porkSPM;
	double chickenSPM;
	double lambSPM;

	shop() {
      //By default the first line is super()
	}
